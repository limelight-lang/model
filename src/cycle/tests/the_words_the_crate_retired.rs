...
const RETIRED: [(&str, &str, Where); 93] = [
    ...
    // The window's control line held a chain of records once. It holds a stack
    // head and a flag, and the retired name sends a reader to `records` for a
