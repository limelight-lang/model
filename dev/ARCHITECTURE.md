...
`cycle::owner_record`),
and the worker's handoff, still S38's.
...
9. **Death is owner-bound.** Every free and every weak-table touch runs
   ...
   candidate deaths after membership and shadow readers end; the worker-side
   proposal remains S38's. Collections run from the poll, explicit fire and
