...
list (S36.2), the per-thread trace token (`cycle::token`: one word taken
...
- bits 16–19, the **maturation stamp** — the epoch a commit wrote it in at
  16–17 and the age at 18–19, laid by S36.6. The one writer is the owning
