...
anything is freed. What is missing between them is the caller: S36.7
wires the collection into the ABI, S36.3 through S36.6 build the guard,
the destructors and the frees. The design is `rfc/model/gc/rc-cycle.md`,
